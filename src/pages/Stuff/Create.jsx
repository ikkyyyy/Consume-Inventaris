...
export default function StuffCreate() {
    ...
    const handleCreateStuff = (event) => {
        ...
        instance.post('stuff/store', forms) // Ganti 'stuff' menjadi 'stuff/create'
            .then(res => {
                setError([]); // Mengosongkan pesan kesalahan jika permintaan berhasil
                setSuccess(true); // Menyetel state success menjadi true
                setTimeout(() => {
                    navigate('/stuff');
            ...
            .catch(err => {
                ...
                // Tambahkan pesan kesalahan yang lebih jelas untuk ditampilkan kepada pengguna
